...
extension Endpoint {
  /**
   ...
   - Parameters:
   - method: The API method for fetching gallery photos
   - apiKey: The API key for authentication
   - galleryId: The ID of the gallery to retrieve photos from
   - format: The response format
   - perPage: The number of photos per page
   - noJsonCallBack: A flag indicating whether to exclude the JSON callback
